...
export class MemoryRepositoryFactory implements IRepositoryFactory {
  ...
  createUserRepository(): IUserRepository {
    return new UserRepository(this.memoryRepository.users, this.memoryRepository.companyUsers, this.memoryRepository.companies)
  }

  createCompanyRepository(): ICompanyRepository {
    return new CompanyRepository(this.memoryRepository.companies, this.memoryRepository.companyUsers)
  }
